        ...
        <div className="animate-fade-in">
          ...
          <div className="space-y-4 md:space-y-0 md:space-x-6 md:flex md:justify-center">
            ...
            <Button 
              ...
              className="border-2 border-white hover:bg-white px-8 py-4 text-lg font-semibold rounded-full transition-all duration-300 backdrop-blur-sm text-slate-500"
            >
              En savoir plus
            </Button>
          </div>
